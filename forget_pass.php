...
if($uname != "" && $pname != "" && $pass != "" && $cpass != ""){
  ...
  $select_que = "select count(*) from signup  where uname = '$uname' and primary_name = '$pname' ";
  $res = mysqli_query($con,$select_que);
$row = mysqli_fetch_array($res);
  if($row[0]>0){


$update_que = "update  signup set pasword = '$pass' , cpasword = '$cpass' where uname = '$uname'";
